...
const BoxThree=()=>{
    ...
    useEffect(()=>{
        ...
        const chart=echarts.init( document.getElementById('myChart3'))
        const options = {
    ...
    return (
        <>
<div className="border border bg-white rounded-md ml-2 h-32  w-68 shadow-xl">
  <div className="m-4 mt-0 mb-0 flex  justify-between">
    ...
    <div id="myChart3" style={{ width: '200%', height: '400px', }} className='w-fit'></div>
