...
const Reviewer=()=>{
    ...
    return (
        ...
        <div className="border border-2px  rounded-md py-2 bg-white" onClick={()=>{setActive(true)}}>
...
{
    active?<div className=" border border-2px rounded-md mt-2 bg-white">

    <div className="flex justify-between">
      <div className="border border-gray-400 m-10 rounded-sm w-1/2 bg-gray-300  " onClick={()=>{setModal(true)}}>
  
     <div  className="flex justify-between m-2 py-2 cursor-pointer">
 ...
 <Slot isVisible={modal} onClose={()=>{setModal(false)}}/>
