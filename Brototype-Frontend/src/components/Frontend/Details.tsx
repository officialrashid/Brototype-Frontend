      ...
      <div className='bg-custom-domain h-96 w-62rem ml-56 mt-12 '>
        ...
        <div className='w-12rem h-auto  gap-4 mt-10rem ml-8rem' >
          <div className='w-12rem h-8'>
            ...
            <p className=' text-sm  px-5 py-3 w-fit'>Get a free counselling session from our  Team</p>
        ...
        <div className='bg-white grid grid-cols-1 w-28rem h-22.5rem ml-32.3125rem rounded-md shadow-xl '>
              ...
              <div>
                ...
                <div className="mt-4">
                  <select
                    ...
                    autoComplete="prefferedLocation"
                    required
