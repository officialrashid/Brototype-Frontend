    ...
    const fetchReviewerProfile = async () => {
        try {
            ...
            if (response?.status==true) {
                ...
                console.log(profileData, "profileSDtaa in superlead for reviewr");
            ...
            <div className="m-8 mr-0 flex h-1/4 w-1/4 items-center justify-center border bg-white shadow rounded-md">
                <div className="flex flex-col items-center w-full">
                    <div className="m-6 mb-0 ml-0 mr-0 h-24 w-24 ">
                        <img src={profileInfo.imageUrl} alt="" className="h-full w-full object-cover rounded-md" />
                    </div>
                    <div className="mt-2">
                    ...
                    <div>
                        <span className="font-roboto inline-flex items-center rounded-md bg-bgsuperLead px-2 py-1 text-xs font-medium text-dark-highBlue cursor-pointer mt-3">Reviewer @Brototype</span>
                    </div>
                    <div className="mt-5 mb-0 ml-4 w-full">
                        ...
                        <div className="mt-5">
                            <ul className="max-w-md space-y-1 text-gray-600 list-none list-inside dark:text-gray-400 text-sm font-roboto ml-3">
                                ...
                                <li className="item items-start pt-2">
                                  Current Working Company: {profileInfo?.CurrentWorkingCompanyName}
                                </li>
                                <li className="item items-start pt-2">
                                ...
                                Preffered Domains For Review: {profileInfo?.PrefferedDomainsForReview}
                                </li>
                                {reviewerStatus.map((status, idx) => (
                                    ...
                                    {reviewerId === status?._id && status?.isStatus === "Active" ? (
                                        ...
                                        <td className="p-0 py-4" key={idx}>
                                            <span className="focus:outline-none text-red-500 hover:text-white bg-red-100 px-2 py-1 hover:bg-red-500 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-xs  mb-2 font-roboto dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-purple-900">Suspend</span>
                                        </td>
                            ...
                            <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                <thead className="text-xs font-roboto text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400 ">
                                    <tr className=''>
                                        ...
                                        <th scope="col" className="px-4 py-3 item text-center">Student</th>
                                        <th scope="col" className="px-8 py-3 item text-center">date</th>
                                        <th scope="col" className="px-4 py-3 item text-center">View Student</th>
                                ...
                                {/* {reviewDetails.map((data, index) => ( */}
                                    <tr className="border-b dark:border-gray-700 item text-center">
                                      <td className="px-4 py-3 text-ms font-roboto"></td>
                                        <td className="px-4 py-3 text-ms font-roboto"></td>
                                        <td className="px-4 py-3 text-sm font-roboto"></td>
                                        <td className="px-4 py-3 text-sm font-roboto"></td>
