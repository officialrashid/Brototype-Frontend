        ...
        <div className="flex justify-center mr-0 mt-36">
            <div className="m-8 mr-0 flex h-1/4 w-1/4 items-center justify-center border bg-white shadow rounded-md">
                <div className="flex flex-col items-center w-full">
                    ...
                    <div className="mt-2">
                        <p className="m-4 mb-0 mt-3 mr-0 text-center font-roboto text-sm font-semibold text-gray-600">Muhammed Rashid K</p>
                    </div>
                    <div>
                    <span className="font-roboto inline-flex items-center rounded-md bg-bgsuperLead px-2 py-1 text-xs font-medium text-dark-highBlue cursor-pointer mt-3">Mern Stack</span>
                    </div>
                    <div className="mt-5 mb-0 ml-4 w-full">
                        ...
                        <div className="mt-5">
                            <ul className="max-w-md space-y-1 text-gray-600 list-none list-inside dark:text-gray-400 text-sm font-roboto ml-3">
                                ...
                                <li className="item items-start pt-2">
                                    Mother's Name: Faseela
                                </li>
                                <li className="item items-start pt-2">
                                    Status: <span className="inline-flex items-center font-roboto rounded-md bg-green-50 px-2 py-1 text-xs font-medium text-green-700 ring-1 ring-inset ring-green-700/10 cursor-pointer">Active</span>
                                </li>
                            </ul>
                        </div>
                            ...
                            <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                <thead className="text-xs font-roboto text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400 ">
                                    <tr className=''>
                                        ...
                                        <th scope="col" className="px-4 py-3 item text-center">date</th>
                                        <th scope="col" className="px-4 py-3 item text-center">pendingTopics</th>
                                        <th scope="col" className="px-4 py-3 item text-center">nextWeekUpdation</th>
                                        <th scope="col" className="px-4 py-3 item text-center">personalWorkoutReview</th>
                                        <th scope="col" className="px-4 py-3 item text-center">CommunicationReview</th>
