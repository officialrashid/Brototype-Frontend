...
const EventModal = () => {
    ...
    const labelsClasses = ["Good", "Average", "Poor", "Outstanding"];
                    ...
                    <div className='p-3 pb-0'>
                        <div className='grid grid-cols-1/5 items-end gap-y-7'>
                            ...
                            <div className='flex flex-3 mb-0 '>
                                <p className='font-roboto'>Enter a Event Title</p>
                                <div className="relative">
                                    <input
                                        ...
                                        value={title}
                                        required
                                        className='pl-2 border-0 text-gray-600 text-sm font-roboto pb-2 w-32 border-b-2 border-gray-200 focus:outline-none focus:ring-0 focus:border-blue-500'
                            ...
                            <div className='flex flex-3 mb-0 '>
                                ...
                                {/* <input className='text-xs underline px-4 py-4' onClick={handleCustomModalChange} /> */}
                            </div>
                            <div className='mb-0 pb-0'> </div>
                        <span>
