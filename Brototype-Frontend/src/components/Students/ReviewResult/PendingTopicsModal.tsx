...
const PendingTopicsModal = ({ isVisible, isClose, week, studentId, batchId }) => {
...
console.log(response,"pending topics modal compngg");
        ...
        if (response ) {
          ...
          if (weekData && weekData.pendingTopics) {
            console.log(weekData.pendingTopics);
            
            setPendingTopics(weekData.pendingTopics);
          } else {
            console.log("{}{}{}{}{");
...
export default PendingTopicsModal;
