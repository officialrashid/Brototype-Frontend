...
const PersonalWorkoutsModal = ({ isVisible, isClose, week, studentId, batchId }) => {
...
console.log(response,"pending topics modal compngg");
        ...
        if (response ) {
          ...
          if (weekData && weekData.personalWorkoutReview) {
            console.log(weekData.personalWorkoutReview);
            
            setPersonalWorkouts(weekData.personalWorkoutReview);
          } else {
            console.log("{}{}{}{}{");
...
export default PersonalWorkoutsModal;
