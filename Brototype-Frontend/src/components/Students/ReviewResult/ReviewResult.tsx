                    ...
                    <table className="w-full text-sm text-center divide-y divide-y-8 border table-fixed border-gray-400 rounded-md font-roboto">
                        <tbody>
                            <tr key={index}>
                                ...
                                <td className="w-1/4 px-5 pr-48 py-6">
                                    yen
                                </td>
                                ...
                                <td className="w-1/4 px-5 py-6">
                                    <span className="inline-flex items-center rounded-md bg-blue-50 px-2 py-1 text-xs font-medium text-blue-700 ring-1 ring-inset ring-blue-700/10 cursor-pointer" >view</span>
                                </td>
                                {/* Add the rest of the columns with the same structure */}
                            </tr>
                        </tbody>
                    </table>
                </div>
